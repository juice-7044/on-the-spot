...
export default function CareersForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    form.reset(); window.location.href = '/careers/thank-you'
  }
